...
define([
    ...
    'css!Leaflet/leaflet.search.css',
    'css!Leaflet/L.Control.Basemaps.css',

    'leaflet',
    'Leaflet/leaflet.awesome-markers',
    ...
    'Leaflet/Leaflet.Editable.Drag',
    'Leaflet/leaflet.search',
    'Leaflet/L.Control.Basemaps',
    'Leaflet/leaflet.MassMarker'
], function () {
    var MapUtil = {
        ready: false,
        Cache: [], // 缓存数据
