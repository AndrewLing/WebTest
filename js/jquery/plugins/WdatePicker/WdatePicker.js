...
//        autoPickDate: null,
    ...
    function V(F) {
        ...
        //else {
            ...
            C = F.parentNode;
            while (C.tagName && Q(C, "position").toLowerCase() != "fixed" && !A.ROOT_TAG.test(C.tagName)) {
...
//			}
    ...
    function I(G, _) {
        ...
        function E(F, E) {
            ...
            G
                .push("<script>var t;t=t||setInterval(function(){if(document.ready){new My97DP();$cfg.onload();$cfg.setPos($dp);clearInterval(t);}},20);if($FF||$OPERA)document.close();</script>");
            E.setPos = B;
            E.onload = Y;
            D.write("<html>");
            D.cfg = E;
