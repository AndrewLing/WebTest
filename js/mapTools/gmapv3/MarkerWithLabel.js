...
function MarkerLabel_(marker) {
    ...
    if (this.id_) this.eventDiv_.id = this.id_;
    this.eventDiv_.style.cssText = this.labelDiv_.style.cssText
        + "width: " + (this.marker_.width || 18) + "px; height: " + (this.marker_.height || 18) + "px; "
        + "margin-left: " + (this.marker_.offset.x) + "px; margin-top: " + (this.marker_.offset.y) + "px;";
