...
function MarkerClusterer(map, opt_markers, opt_options) {
    ...
    //    debugger
    //    var minZoom = that.map_.mapTypes[that.map_.getMapTypeId()].minZoom || 0;
    //    var maxZoom = that.map_.mapTypes[that.map_.getMapTypeId()].maxZoom || 21;
    ...
    google.maps.event.addListener(this.map_, 'idle', function () {
        var minZoom = that.map_.mapTypes[that.map_.getMapTypeId()].minZoom || 3;
        var maxZoom = that.map_.mapTypes[that.map_.getMapTypeId()].maxZoom || 18;
        var zoom = that.map_.getZoom();
        if (zoom < minZoom || zoom > maxZoom) {
            return;
        }
 ...
 * @private
 */
MarkerClusterer.prototype.MARKER_CLUSTER_IMAGE_PATH_ = '/markers/m';
...
ClusterIcon.prototype.triggerClusterClick = function () {
    ...
    if (markerClusterer.isZoomOnClick()) {
        ...
        //setTimeout((function (map, cluster) {
        //    return function () {
        //        map.panTo(cluster.getCenter());
        //        map.setZoom(map.getZoom() + 2);
        //    };
        //})(this.map_, this.cluster_), 0);
